  ...
  <div class="login-box-body">
    ...
    <form action="/admin/login" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Submeter</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <a href="/admin/forgot">Esqueci a password</a><br>
    <a href="register.html" class="text-center">Novo utilizador</a>
